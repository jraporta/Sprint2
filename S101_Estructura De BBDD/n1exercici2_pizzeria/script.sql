...
-- Schema n1exercici2_pizzeria
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `n1exercici2_pizzeria` DEFAULT CHARACTER SET utf8mb4 ;
...
-- -----------------------------------------------------
-- Table `n1exercici2_pizzeria`.`localidad`
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Table `n1exercici2_pizzeria`.`cliente`
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Table `n1exercici2_pizzeria`.`trabajador`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `n1exercici2_pizzeria`.`trabajador` (
...
-- -----------------------------------------------------
-- Table `n1exercici2_pizzeria`.`pedido`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `n1exercici2_pizzeria`.`pedido` (
  ...
  CONSTRAINT `fk_pedido_trabajador1`
    ...
    REFERENCES `n1exercici2_pizzeria`.`trabajador` (`trabajador_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_pedido_cliente1`
    FOREIGN KEY (`cliente_id`)
    REFERENCES `n1exercici2_pizzeria`.`cliente` (`cliente_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
...
-- -----------------------------------------------------
-- Table `n1exercici2_pizzeria`.`categoriaPizza`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `n1exercici2_pizzeria`.`categoriaPizza` (
...
-- -----------------------------------------------------
-- Table `n1exercici2_pizzeria`.`producto`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `n1exercici2_pizzeria`.`producto` (
  ...
  CONSTRAINT `fk_producto_categoriaPizza1`
    ...
    REFERENCES `n1exercici2_pizzeria`.`categoriaPizza` (`categoriaPizza_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `n1exercici2_pizzeria`.`detalle_pedido`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `n1exercici2_pizzeria`.`detalle_pedido` (
  ...
  CONSTRAINT `fk_detalle_pedido_pedido1`
    ...
    REFERENCES `n1exercici2_pizzeria`.`pedido` (`pedido_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_detalle_pedido_producto1`
    FOREIGN KEY (`producto_id`)
    REFERENCES `n1exercici2_pizzeria`.`producto` (`producto_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
